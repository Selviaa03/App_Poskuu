<div id="barang">
	...
	<button data-toggle="modal" data-target="#tmbhbarang" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span>   Tambah Barang</button>
	...
	<table class="table table-striped table-bordered table-hover" id="dataTables-example">
		...
		<?php $no = 1; foreach($barang as $s) { ?>
			<tr class="gradeU">
				...
				<td><?php echo anchor('barang/edit/'.$s->id_barang,'Edit',array('class'=>'btn btn-default')); ?> || <?php echo anchor('barang/hapus/'.$s->id_barang,'Hapus',array('class'=>'btn btn-danger')); ?>
				</td>
			</tr>
		<?php } ?>
		</tbody>
